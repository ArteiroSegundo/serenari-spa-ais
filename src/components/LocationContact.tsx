...
export function LocationContact() {
  return (
    <section id="contato" className="py-24 bg-[#142b17] text-white relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base text-emerald-100/80 mt-3 font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/15 shadow-2xl flex flex-col justify-between space-y-8"
          >
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-2xl bg-[#a24f24] text-white shrink-0 shadow-md">
              ...
              {/* Horário */}
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-2xl bg-[#225627] text-white shrink-0 border border-white/10">
              ...
              {/* Telefone e Email */}
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-2xl bg-white/10 text-amber-300 shrink-0 border border-white/15">
            ...
            <div className="space-y-3 pt-6 border-t border-white/15">
              <a
                ...
                className="w-full py-4 px-6 rounded-2xl bg-[#225627] hover:bg-[#1a441e] text-white font-bold text-sm shadow-lg flex items-center justify-center gap-3 transition-all transform hover:-translate-y-0.5"
              >
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-white/5 p-3 rounded-3xl border border-white/15 shadow-2xl relative min-h-[420px]"
          >
            <iframe
              title="Serenari Spa Localização em Suzano/SP"
